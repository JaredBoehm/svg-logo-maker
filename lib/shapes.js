...
class Square extends Shape {
    ...
    renderText() {
        return `<text x="110" y="130" font-size="16px" fill="${this.textColor}">${this.text}</text>`
    }
}
...
class Triangle extends Shape {
    ...
    renderShape() {
        return `<path d="M 127.16651,84.016145 200,149.8037 H 50.000001 Z" fill="${this.shapeColor}"/>`
    }
    renderText() {
        return `<text x="110" y="130" font-size="16px" fill="${this.textColor}">${this.text}</text>`
    }
